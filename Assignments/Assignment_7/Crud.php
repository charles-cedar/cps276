...
class Crud extends PdoMethods{
	...
	public function getNames($type){
		...
		/* CREATE THE SQL */
		$sql = "SELECT file_name FROM assignment7";
	...
	public function addName(){
		...
		$sql = "INSERT INTO assignment7 (file_name, file_path) VALUES (:name, :path)";
		
			 
	    /* THESE BINDINGS ARE LATER INJECTED INTO THE SQL STATEMENT THIS PREVENTS AGAIN SQL INJECTIONS */
	    $bindings = [
			[':name',$_POST['fileNameInput'],'str'],
			[':path','/home/e/l/elixey/public_html/Assignments/Assignment_7/pdfFiles/newsletterorform1.pdf','str']
	...
	private function createList($records){
		...
		foreach ($records as $row){
			$list .= "<li><a target='_blank' href='pdfFiles/newsletterorform1.pdf'>{$row['file_name']}</a></li>";
