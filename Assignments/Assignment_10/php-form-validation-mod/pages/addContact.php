...
$elementsArr = [
  "masterStatus"=>[
	...
	"address"=>[
	  "errorMessage"=>"<span style='color: red; margin-left: 15px;'>Address must be in the proper format and cannot be blank</span>",
    "errorOutput"=>"",
    "type"=>"text",
    "value"=>"123 Main St",
		"regex"=>"address"
  ...
  "city"=>[
	  "errorMessage"=>"<span style='color: red; margin-left: 15px;'>City cannot be blank and must only contain letters</span>",
    "errorOutput"=>"",
    "type"=>"text",
    "value"=>"Ann Arbor",
		"regex"=>"city"
  ...
  "dob"=>["errorMessage"=>"<span style='color: red; margin-left: 15px;'>DOB cannot be blank</span>",
  "errorOutput"=>"",
  "type"=>"date",
  "value"=>"11/11/1911",
  "regex"=>"dob"
  ...
  "contactType"=>[
    "errorMessage"=>"<span style='color: red; margin-left: 15px;'>You must select at least one Contact Type option</span>",
    "errorOutput"=>"",
    "type"=>"checkbox",
    "action"=>"notRequired",
...
function addData($post){
  ...
  /* IF EVERYTHING WORKS ADD THE DATA HERE TO THE DATABASE HERE USING THE $_POST SUPER GLOBAL ARRAY */
      ...
      $sql = "INSERT INTO contacts (contact_name, contact_address, contact_city, contact_state, contact_phone, contact_email, contact_dob, contact_types, contact_age) VALUES (:name, :address, :city, :state, :phone, :email, :dob, :contactType, :age)";

      date_default_timezone_set('America/Detroit');
      $convertedDate = strtotime($_POST['dob']);
...
$form = <<<HTML
    ...
    <p>Please check all contact types you would like (optional):{$elementsArr['contactType']['errorOutput']}</p>
    ...
    <div class="form-check form-check-inline">
      <input class="form-check-input" type="checkbox" name="contactType[]" id="contactType2" value="Email Updates" {$elementsArr['contactType']['status']['Email Updates']}>
      <label class="form-check-label" for="contactType2">Email Updates</label>
    </div>
    <div class="form-check form-check-inline">
      <input class="form-check-input" type="checkbox" name="contactType[]" id="contactType3" value="Text Updates" {$elementsArr['contactType']['status']['Text Updates']}>
